...
public class TextureRepository {
	...
	public static int X = TextureLoader.loadTexture("assets/uis/x");
	public static int DISPLAY = TextureLoader.loadTexture("assets/uis/display");
	public static int BACK = TextureLoader.loadTexture("assets/uis/back");
	public static int GFX = TextureLoader.loadTexture("assets/uis/gfx");
	public static int FOLDER = TextureLoader.loadTexture("assets/uis/folder");
