...
public class QEFData {
    ...
    public void qef_create_from_points(Vector4f[] positions, Vector4f[] normals, int count) {
        ...
        massPoint = massPoint.divide(massPoint.w);
    }
    ...
    public static void main(String[] args) {
        ...
        final int count = 5;
        Vector4f[] normals = {
                new Vector4f( 1.0f,1.0f,0.0f).normalize(),
                new Vector4f( 1.0f,1.0f,0.0f).normalize(),
                new Vector4f(-1.0f,1.0f,0.0f).normalize(),
                new Vector4f(-1.0f,2.0f,1.0f).normalize(),
                new Vector4f(-1.0f,1.0f,0.0f).normalize(),
        };
        Vector4f[] points = {
                new Vector4f(  1.0f, 0.0f, 0.3f),
                new Vector4f(  0.9f, 0.1f, -0.5f),
                new Vector4f( -0.8f, 0.2f, 0.6f),
                new Vector4f( -1.0f, 0.0f, 0.01f),
                new Vector4f( -1.1f, -0.1f, -0.5f),
        };
