...
public class MetaFile {
    ...
    public MetaFile(String file) {
        this.aspectRatio = (double) WindowManager.getWindowSizeX(Engine.getWindowInstance().getWindowID()) / (double) WindowManager.getWindowSizeY(Engine.getWindowInstance().getWindowID());
